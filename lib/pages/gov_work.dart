...
class PlasticSectionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Plastic Section'),
        backgroundColor: Color(0xFFB3E5FC), // Pastel Blue
      ),
      body: Padding(
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                color: Color(0xFFFACCCC), // Pastel Pink
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Container(
                    decoration: BoxDecoration(
                      color: Color.fromARGB(255, 241, 250, 204), // Pastel Pink
                      borderRadius:
                          BorderRadius.circular(16.0), // Rounded corners
                    ),
                    height: screenHeight * 0.3, // 30% of screen height
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Card(
                color: Color.fromARGB(255, 253, 224, 224), // Pastel Pink
                elevation: 5,
