...
import 'package:plastic_eliminator/features/Home/shops_page/allShops_detailspage.dart';
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          '${shopData['description'] ?? 'No Description'}\nHome Delivery: ${shopData['home_delivery'] ?? 'Not Available'}',
                        ),
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => ShopDetailsPage(
                                ...
                                phoneNumber: shopData['phoneNumber'] ?? 'No Phone Number',
                                address: shopData['address'] ?? 'No Address',
                                description: shopData['description'] ?? 'No Description',
                                homeDelivery: shopData['home_delivery'] ?? 'Not Available',
                              ),
                            ),
                          );
                        },
