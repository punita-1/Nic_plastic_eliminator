...
import 'package:plastic_eliminator/features/Home/New_in_eliminator/swiper_pages.dart';
import 'package:plastic_eliminator/features/Home/activities.dart';
import 'package:plastic_eliminator/features/Home/drawer_items/NGO_pages.dart/All_ngo.dart';
import 'package:plastic_eliminator/features/Home/drawer_items/clubs.dart';
import 'package:plastic_eliminator/features/Home/drawer_items/learning_admin.dart';
import 'package:plastic_eliminator/features/Home/drawer_items/news.dart';
import 'package:plastic_eliminator/features/Home/events_pages/events.dart';
import 'package:plastic_eliminator/features/Home/quotes.dart';
import 'package:plastic_eliminator/features/Home/school_pages/school_list.dart';
import 'package:plastic_eliminator/features/Home/shops_page/allshops.dart';
import 'package:plastic_eliminator/features/Home/shops_page/shoplist.dart';
import 'package:plastic_eliminator/features/community_page/leader_board.dart';
import 'package:plastic_eliminator/features/info_drawer_items/about.dart';
import 'package:plastic_eliminator/features/info_drawer_items/contact.dart';
import 'package:plastic_eliminator/features/info_drawer_items/faq.dart';
import 'package:plastic_eliminator/features/profile_page/local_notifier.dart';
import 'package:plastic_eliminator/features/profile_page/profile.dart';
  ...
  Widget _buildContent() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 15.0),
        Container(height: 80, child: SchoolListPage()),
        SizedBox(height: 10.0),
        Container(height: 220, child: SwiperPageNew()),
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
              height: 95,
              child: Image(
                  image: AssetImage('Assets/onboard_images/onboard1.png'))),
        ],
      ),
    );
  }
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
              height: 100,
              child: Image(
                  image: AssetImage('Assets/onboard_images/onboard2.png'))),
        ],
      ),
    );
  }
        ...
        children: [
          Text(
            AppLocalizations.of(context)!.greenYourShopping +
                '\n' +
                AppLocalizations.of(context)!.discoverPlasticFreeShops,
            style: Theme.of(context)
                .textTheme
                .bodyLarge
                ?.copyWith(color: Colors.white),
          ...
          Container(
              height: 120,
              child: Image(
                  image: AssetImage('Assets/onboard_images/onboard3.png'))),
        ],
      ),
    );
  }
